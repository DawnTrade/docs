...
<Warning>
  Switching profiles does not stop automation. Stop-losses, take-profits, limit orders and DCA plans keep running in every profile, whether or not you are looking at it. Check `/orders` in each profile before you assume nothing is armed.
</Warning>
