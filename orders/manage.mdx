...
Send `/orders`, or tap **📋 Limit Orders** on the home screen. Everything armed lives here, grouped by coin: limit buys and sells, ladders, DCA plans, running TWAPs, and the take-profit and stop-loss levels on your positions.

A coin's own panel lists what is waiting on it, and the **⚙️ Automations** button carries the count.

<Note>
  [Price alerts](/alerts/price) have their own list: **🔔 Price Alerts** on the home screen, or `/alerts`. Once you have one, this page links to it too.
</Note>
...
| **⏹ Stop TWAP** | Stops that TWAP. Slices already done stay done. |
| **🗑 Cancel All** | Clears everything on the page except DCA plans and TWAPs |
