...
Every slice that fills also sends a short message, like _Slice 3/30 filled_ with what it bought or sold. A last message sums the TWAP up when it finishes, or when it stops on its own.
