...
Dawn is a Telegram bot for trading memecoins. You hold **one USDC balance** and spend it on **Solana, BNB Chain, Robinhood Chain, Base, Arc and Ink**. Dawn does the routing, pays the gas and handles the bridging in the background, so reaching a coin on another chain takes no extra steps and no second balance.
