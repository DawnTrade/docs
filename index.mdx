...
## How Dawn fits everything together
...
<Columns cols={2}>
  <Card title="Discover Trending Coins" icon="fire" href="/trading/trending">
    Browse what is trending, narrow it to a chain, or search by ticker.
  </Card>

  <Card title="Understand Token Panels" icon="table-columns" href="/trading/token-panel">
  ...
  <Card title="Every Telegram Command" icon="terminal" href="/help/commands">
    A one-line reference for each slash command on the bot.
  </Card>

  <Card title="Something went wrong?" icon="life-ring" href="/help/troubleshooting">
    Frequently asked questions about things that might be confusing. 
  </Card>

  <Card title="Rewards on Dawn" icon="ranking-star" href="/rewards/tiers">
    Every cashback and referral level, and what it takes to reach it.
  </Card>
</Columns>
