...
<AccordionGroup>
  ...
  <Accordion title="A send is waiting on Approve in Wallet" icon="signature">
    ...
    A send you do not approve within **five minutes** expires. Start it again from the chat.
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  ...
  <Accordion title="I cannot find an order I placed" icon="magnifying-glass">
    ...
    Running TWAPs are listed there too. Price alerts have their own list: **🔔 Alerts** → **📈 Price** on the home screen, or `/alerts`.
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion title="A trader's alerts have gone quiet" icon="bell">
    Open the trader from **🔔 Alerts** → **👥 Traders** and check they are not **paused**.
