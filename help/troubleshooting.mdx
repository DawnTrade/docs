...
<AccordionGroup>
  ...
  <Accordion title="My copy filled far from the leader's price" icon="chart-line">
    Your copy is placed after the leader's buy, so the price has already moved. Smaller sizes, a liquidity floor in the task's [filters](/copytrade/manage#filters) and a stop loss on the task all help.
  </Accordion>
