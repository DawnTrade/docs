...
<AccordionGroup>
  ...
  <Accordion title="I cannot find an order I placed" icon="magnifying-glass">
    ...
    Price alerts are in `/alerts`, and a running TWAP lives on its own card.
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion title="A trader's alerts have gone quiet" icon="bell">
    Open the trader from **🔔 Alerts** and check they are not **paused**, that **Buys** and **Sells** are on, and what their **🔍 Trade Filters** leave out. Filters only narrow buys — sells and theses always come through.
  </Accordion>
