...
| ⚙️ **Automations** | Unfolds the order-setting buttons below. The badge counts the orders, alerts and running TWAPs on this coin. |
...
| ⏲ **TWAP** | Split a buy or a sell into small trades over time. While some are running on the coin it shows how many, like **⏲ TWAP (1)**. See [TWAP](/orders/twap). |
