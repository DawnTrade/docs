...
Closed positions are summed up per coin here. For the trade-by-trade log — every buy and sell, and what each sell realised — see [Activity](/trading/activity).
...
Long lists fill up with dust and dead coins. Two fold-out rows sit on the page itself — **💳 Wallets** and **⛓ Chains**, each saying how many are ticked — and **🔍 Filters** holds the rest:

| Filter | What it does |
| --- | --- |
| **Wallets** | On the page: show only the wallets you tick. |
| **Chains** | On the page: show only the chains you tick. |
