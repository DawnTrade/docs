...
Your balance is **USDC on Solana.** Buying a coin on BNB Chain, Robinhood Chain, Base, Arc or Ink means moving value across, **_and that routing has a cost of its own._**
...
Gas that was already spent on a submitted transaction is not recoverable, however **we cover this for you.**
